...
export const uploadAvatarSchema = z.object({
  file: z.object({
    mimetype: z.string().startsWith('image/png', 'Only png images are accepted'),
...
export type beta_UploadAvatarUrlInput = z.infer<typeof beta_uploadAvatarUrlSchema>['body'];
